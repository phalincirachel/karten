...
// Geprüfte Einzeldateien ersparen bei diesen Medien eine unspezifische Bildsuche.
const verifiedCommons=(path,file,caption)=>I(`https://upload.wikimedia.org/wikipedia/commons/${path}`,`https://commons.wikimedia.org/wiki/File:${encodeURIComponent(file)}`,caption,"Wikimedia Commons");
...
(() => {
  const card=(category,title,summary,detail,media,sources,searchTerm,extra={})=>({category,title,summary,detail,media:media.map(item=>({...item,fit:"contain"})),sources,searchTerm,...extra});
  const diagram=(name,caption)=>I(`assets/diagrams/${name}.svg`,`assets/diagrams/${name}.svg`,caption,"Eigene Darstellung");
  const wiki=(page,language="de")=>({page,language});
  const wm=verifiedCommons;
  const wharton="https://raw.githubusercontent.com/GITenberg/The-writing-of-fiction_72446/master/72446-0.txt";
  window.KARTEN.push(
    card("Aphorismen","„Von einem gewissen Punkt an gibt es keine Rückkehr mehr. Dieser Punkt ist zu erreichen.“","",[],[
      wm("1/16/Franz_Kafka_in_1917.jpg","Franz Kafka in 1917.jpg","Franz Kafka, 1917")
    ],[S("Kafka: Zürauer Aphorismen, Nr. 5","https://de.wikisource.org/wiki/Betrachtungen_%C3%BCber_S%C3%BCnde,_Leid,_Hoffnung_und_den_wahren_Weg")],"Franz Kafka Zürauer Aphorismen 5 Punkt Rückkehr",{kind:"quote",byline:"Franz Kafka · Zürauer Aphorismen, Nr. 5 (1917/18)"}),

    card("Historische Anekdoten","Thomas Blood und die Kronjuwelen · London, 1671","Karl II. begnadigte den Mann, der seine Krone stehlen wollte.",[
      "Am 9. Mai 1671 ließ sich Thomas Blood im Londoner Tower die Kronjuwelen zeigen. Er hatte zuvor, als Geistlicher verkleidet, das Vertrauen des Aufsehers Talbot Edwards gewonnen. Nun überwältigten Blood und seine Begleiter den alten Mann. Sie drückten die Krone zusammen, um sie unter der Kleidung zu verbergen. Als Edwards’ Sohn unvermutet erschien und seine Tochter Alarm schlug, flohen die Täter. Die Wachen nahmen sie noch am Tower fest.",
      "Blood verlangte, mit Karl II. zu sprechen. Der König empfing ihn und begnadigte ihn anschließend; die Begnadigung vom 1. August 1671 ist in den Staatsakten erhalten. Weshalb Karl so entschied, ist ungeklärt. Die verbreitete Erklärung, der König sei vom Witz des Diebes begeistert gewesen, behandelt eine Vermutung wie eine gesicherte Unterhaltung. Blood war in politische Verschwörungen verwickelt und besaß Kontakte zu Gegnern der Monarchie. Welchen Nutzen der König sich davon versprach, lässt die Begnadigungsurkunde offen."
    ],[wm("2/25/Portrait_of_Thomas_Blood.jpg","Portrait of Thomas Blood.jpg","Thomas Blood, zeitgenössisches Porträt")],[S("Historic Royal Palaces: The Crown Jewels","https://www.hrp.org.uk/tower-of-london/history-and-stories/the-crown-jewels/"),S("National Archives: The King, the Crown and the Colonel","https://www.nationalarchives.gov.uk/education/resources/the-king-the-crown-the-colonel/")],"Thomas Blood Talbot Edwards 1671 pardon National Archives"),

    card("Philosophische Begriffe","Moralischer Zufall","Umstände außerhalb unserer Kontrolle beeinflussen, wie wir moralisch beurteilt werden.",[
      "Zwei Fahrer gehen dasselbe unvertretbare Risiko ein. Nur vor einem der beiden Wagen tritt jemand auf die Straße. Ihr Verhalten war gleich fahrlässig; allein einer hat nun einen Menschen verletzt. Das Beispiel trennt die Bewertung der Entscheidung von der Bewertung ihrer Folgen. Thomas Nagel und Bernard Williams untersuchten in den 1970er Jahren, weshalb solche Unterschiede unsere Urteile verändern, obwohl Verantwortlichkeit gewöhnlich Kontrolle voraussetzt."
    ],[],[S("Wikipedia: Moralischer Zufall","https://de.wikipedia.org/wiki/Moralischer_Zufall"),S("Stanford Encyclopedia: Moral Luck","https://plato.stanford.edu/entries/moral-luck/")],"Moralischer Zufall Nagel Williams Kontrolle Verantwortung",{wiki:wiki("Moralischer Zufall")}),

    card("Künstler und drei Werke","Harald Sohlberg","Sommernacht · Fischerhaus · Winternacht in den Bergen",[
      "Harald Sohlberg (1869–1935) malte norwegische Landschaften nach langen Studien am jeweiligen Ort. In „Sommernacht“ von 1899 steht auf einer Veranda noch das Geschirr einer Mahlzeit. Die Stühle sind leer; hinter der Brüstung liegen der dunkle Garten und der helle Fjord. Der nahe Tisch gibt dem weiten Ausblick einen menschlichen Maßstab.",
      "Im „Fischerhaus“ von 1906 verdecken Baumstämme Teile der Küste und des Hauses. Der Betrachter steht im Schatten und sieht auf die beleuchtete Fassade. „Winternacht in den Bergen“ von 1914 kehrt dieses Verhältnis um: Dunkle Bäume rahmen die fernen Schneegipfel des Rondanegebirges. Für dieses Motiv arbeitete Sohlberg über Jahre an Zeichnungen und Fassungen. In allen drei Bildern bestimmt der dunkle Vordergrund genau, wie viel von der helleren Ferne sichtbar wird."
    ],[
      wm("thumb/8/81/Harald_Sohlberg_-_Summer_Night_-_Google_Art_Project.jpg/1280px-Harald_Sohlberg_-_Summer_Night_-_Google_Art_Project.jpg","Harald Sohlberg - Summer Night - Google Art Project.jpg","Sommernacht, 1899"),
      wm("1/1d/Fisherman%27s_cottage_sohlberg.jpg","Fisherman's cottage sohlberg.jpg","Fischerhaus, 1906"),
      wm("thumb/8/8f/Harald_Sohlberg_-_Winter_Night_in_the_Mountains_-_Google_Art_Project.jpg/1280px-Harald_Sohlberg_-_Winter_Night_in_the_Mountains_-_Google_Art_Project.jpg","Harald Sohlberg - Winter Night in the Mountains - Google Art Project.jpg","Winternacht in den Bergen, 1914")
    ],[S("Nasjonalmuseet: Harald Sohlberg","https://www.nasjonalmuseet.no/en/collection/object/NG.K_H.1996.0043"),S("Nasjonalmuseet: Ausstellung und Werkangaben","https://www.mynewsdesk.com/no/nasjonalmuseet/pressreleases/stor-harald-sohlberg-utstilling-i-nasjonalgalleriet-2677170")],"Harald Sohlberg Sommernacht Fischerhaus Winternacht Rondane",{works:["Sommernacht, 1899","Fischerhaus, 1906","Winternacht in den Bergen, 1914"]}),

    card("Erste Sätze großer Romane","When her father died, Laura Willowes went to live in London with her elder brother and his family.","",[],[
      wm("4/43/Sylvia_Townsend_Warner_in_1934_crop.png","Sylvia Townsend Warner in 1934 crop.png","Sylvia Townsend Warner, 1934")
    ],[S("Erstausgabe: Lolly Willowes, 1926","https://www.gutenberg.org/ebooks/72223"),S("Wikipedia: Lolly Willowes","https://en.wikipedia.org/wiki/Lolly_Willowes")],"Sylvia Townsend Warner Lolly Willowes 1926 Laura",{kind:"quote",byline:"Sylvia Townsend Warner · Lolly Willowes (1926)",wiki:wiki("Lolly Willowes","en")}),

    card("Seltene Musikstile","Bećarac · Slawonien, Baranja und Syrmien","Zehnsilbige Zweizeiler im Wechsel zwischen Vorsängern und Gruppe.",[
      "Bećarac wird im Osten Kroatiens gesungen, besonders in Slawonien um Osijek und in den angrenzenden Regionen Baranja und Syrmien. Bei Hochzeiten und anderen Feiern treten kräftige Solostimmen aus der Gruppe hervor. Sie wählen oder erfinden Zweizeiler mit jeweils zehn Silben; die übrigen Sänger antworten, häufig begleitet von Tamburica-Zupfinstrumenten.",
      "Zu hören ist der UNESCO-Film über die Singpraxis. Achte auf die Wiederholung der Melodie: Der musikalische Rahmen bleibt erkennbar, während die Worte auf die anwesenden Personen und die letzte Strophe reagieren. Die zweite Zeile beantwortet oder verdreht oft die erste. Dadurch entsteht ein Wettbewerb um die passende Erwiderung. Wie lange er dauert, entscheidet sich während des Singens."
    ],[Y("6_Kw18DWHP4","Bećarac · Dokumentation des kroatischen Kulturministeriums, UNESCO")],[S("UNESCO: Bećarac","https://ich.unesco.org/en/RL/bearac-singing-and-playing-from-eastern-croatia-00358"),S("UNESCO: Dokumentarfilm","https://ich.unesco.org/en/video/5872")],"Bećarac Slavonija Baranja Srijem decasyllabic UNESCO"),

    card("Vergessene Komponisten","Amanda Maier · Violinsonate h-Moll","Der langsame Satz enthält einen lebhaften Mittelteil und eine veränderte Rückkehr.",[
      "Amanda Maier (1853–1894) stammte aus Landskrona in Südschweden und war selbst Konzertgeigerin. Ihre Sonate für Violine und Klavier entstand im Dezember 1873 in Leipzig. Als ein Gutachter des Verlags Änderungen am langsamen Satz vorschlug, widersprach sie: Die Fassung sei ihr so vertraut geworden, dass sie diese unverändert veröffentlichen wolle. 1878 erschien das Werk in dieser Form.",
      "Zu hören ist besonders der zweite Satz, Andantino, in G-Dur. Eine ruhige Melodie im Dreiachteltakt wird von einem schnelleren Allegretto unterbrochen; danach kehrt das Anfangstempo zurück. Die Wirkung hängt an diesem Größenverhältnis: Der Mittelteil besitzt genug Eigengewicht, um die Ruhe der Wiederkehr neu hörbar zu machen. Im gesamten Werk erhält das Klavier einen ausgearbeiteten Part neben der Geige. Maiers Erfahrung als Solistin zeigt sich in der beweglichen Geigenstimme, ohne den Satz auf Vorführungseffekte zu reduzieren. Das eingebettete Video enthält die vollständige dreisätzige Sonate."
    ],[Y("GF5JhYOOX5s","Amanda Maier · Sonate für Violine und Klavier h-Moll, vollständig")],[S("Schwedische Musikakademie: kritischer Werkkatalog","https://www.swedishmusicalheritage.com/composers/maier-rontgen-amanda/SMH-W180-Sonata_B_minor_for_Piano_and_Violin"),S("Schwedische Musikakademie: Leben und Werk","https://www.swedishmusicalheritage.com/composers/maier-rontgen-amanda/")],"Amanda Maier violin sonata Andantino 1873 Hiller letter"),

    card("Großartige Bilder und Design","Adelaide Alsop Robineau · Scarab Vase","Porzellan, 1910 · Die Wandung wurde vor dem Brand von Hand durchbrochen.",[
      "Adelaide Alsop Robineau fertigte die „Scarab Vase“, auch „Apotheosis of the Toiler“ genannt, 1910 an der University City Pottery bei St. Louis. In die lederharte Porzellanwand schnitt sie ein dichtes Relief mit Skarabäen und dazwischen offenen Feldern. Der Hals bleibt vergleichsweise glatt; darunter wird die Wandung zu einem feinen, geschlossenen Geflecht aus Stegen.",
      "Die Schwierigkeit lag im Porzellan selbst. Beim Trocknen und Brennen schrumpft es; die unterschiedlich dicken Partien mussten diese Veränderung überstehen. Das Muster ist deshalb zugleich Ornament und eine Prüfung der verbleibenden Wandstärke. 1911 wurde die Vase auf der Turiner Ausstellung ausgezeichnet. Das Original befindet sich heute im Everson Museum in Syracuse. Die historische Aufnahme zeigt Robineau bei der Arbeit; daneben steht eine Fotografie der fertigen Vase."
    ],[
      wm("b/be/Adelaide_Robineau_working_on_her_scarab_vase_%28cropped%29.jpg","Adelaide Robineau working on her scarab vase (cropped).jpg","Robineau bei der Arbeit an der Vase"),
      I("https://gcc.glendale.edu/ceramics/gif%20resource%20file/scarabvase1587.jpg","https://gcc.glendale.edu/ceramics/scarabvase.html","Scarab Vase, 1910 · das fertige Porzellangefäß","Everson Museum / Glendale Community College")
    ],[S("Everson Museum: Scarab Vase","https://everson.org/object-of-the-week/object-of-the-week-adelaide-alsop-robineaus-scarab-vase/"),S("Everson Museum: Keramiksammlung","https://everson.org/explore/permanent-collection/ceramics-2/")],"Adelaide Alsop Robineau Scarab Vase pierced porcelain 1910"),

    card("Märchen und Sagen in ethnografischen Quellen","Der Tiger und die Affen · Khasi","K. U. Rafy · Folk-Tales of the Khasis, Erzählung VII (1920)",[
      "Die Khasi leben im heutigen indischen Bundesstaat Meghalaya, im Hügelland südlich des Brahmaputratals und um die Stadt Shillong. Khasi ist eine gebräuchliche Selbst- und Fremdbezeichnung; die Sprache gehört zur austroasiatischen Sprachfamilie. K. U. Rafy veröffentlichte diese englische Nacherzählung 1920. Für die einzelne Geschichte nennt die Ausgabe weder eine Gewährsperson noch ein Aufzeichnungsdatum.",
      "Die Tiere haben den Tiger wegen seiner Stärke zum König gewählt. Als er ein Insekt singen hört, behauptet ein junger Affe aus Übermut, seine Schwester singe so schön. Der Tiger verlangt, sie zu heiraten. Um ihren Bruder vor der Strafe für diese Lüge zu retten, formen die Affen eine Braut aus Lehm. Bei der Hochzeit löst der Tiger deren Kopf. Die Affen beschuldigen ihn daraufhin, ihre Schwester getötet zu haben, und fallen gemeinsam über ihn her."
    ],[wm("3/3f/Khasi_landscape.jpg","Khasi landscape.jpg","Hügellandschaft im Siedlungsgebiet der Khasi")],[S("Rafy: Folk-Tales of the Khasis, 1920","https://www.gutenberg.org/ebooks/37884"),S("Vollständige Transkription","https://raw.githubusercontent.com/GITenberg/Folk-Tales-of-the-Khasis_37884/master/37884.txt")],"K U Rafy Tiger Monkeys Khasi 1920 Meghalaya",{languageInfo:[["Region und Gemeinschaft","Khasi-Hügel um Shillong, Meghalaya, Nordostindien · Khasi"],["Überlieferung","K. U. Rafy, englische Veröffentlichung 1920; einzelne Gewährsperson nicht angegeben"]],original:{label:"The Tiger and the Monkeys · K. U. Rafy, 1920",source:"https://www.gutenberg.org/ebooks/37884",remote:{url:"https://raw.githubusercontent.com/GITenberg/Folk-Tales-of-the-Khasis_37884/master/37884.txt",start:"THE TIGER AND THE MONKEYS",end:"VIII\n\nTHE LEGEND OF THE IEI TREE",startLast:true,flexibleMarkers:true,reflow:true,fetchLabel:"GITenberg-Transkription, Erzählung VII"}}}),

    card("Sagengestalten, Legenden und Märchen weltweit","Kiviuq · Inuit","Die Reisen eines Jägers, der einen von einer alten Frau herbeigerufenen Sturm überlebt.",[
      "Kiviuq gehört zu den weit verbreiteten Erzählfiguren der Inuit im arktischen Kanada. Sein Name erscheint auch als Kiviuk oder Kiviok. Die Geschichten wurden in unterschiedlichen örtlichen Folgen erzählt; ein einheitlicher Text mit festem Anfang und Ende liegt ihnen nicht zugrunde.",
      "In einer Fassung aus der Kivalliq-Region westlich der Hudson Bay lebt ein verspotteter Waisenjunge bei seiner Großmutter. Sie verwandelt ihn in eine Robbe. Als die Männer des Ortes das Tier im Kajak verfolgen, ruft sie einen Sturm herbei, in dem die Verfolger umkommen. Kiviuq, der den Jungen freundlich behandelt hatte, überlebt. Damit beginnen seine Reisen zu fremden Küsten und zu Wesen, deren menschliche oder tierische Gestalt wechselt. Die örtlichen Fassungen unterscheiden sich sowohl in der Reihenfolge dieser Begegnungen als auch in ihrer Länge."
    ],[],[S("Wikipedia: Kiviuq","https://en.wikipedia.org/wiki/Kiviuq"),S("Avataq Cultural Institute: Unikkaangualaurtaa","https://www.avataq.qc.ca/en/content/download/2270/32365/file/Tell%20Me%20a%20Story.pdf")],"Kiviuq Kivalliq orphan grandmother seal storm Inuit",{wiki:wiki("Kiviuq","en")}),

    card("Literarische und filmische Tropen und Typenszenen","Der Doppelgänger als Herrscher","Die Ähnlichkeit eines Körpers hält eine politische Ordnung aufrecht.",[
      "In Anthony Hopes Roman „The Prisoner of Zenda“ von 1894 muss Rudolf Rassendyll einen König ersetzen, der vor seiner Krönung außer Gefecht gesetzt und später gefangen gehalten wird. Hofleute lehren den Engländer die nötigen Umgangsformen. Die Ähnlichkeit ermöglicht zunächst die öffentliche Zeremonie; die längere Vertretung verlangt anschließend Entscheidungen und persönliche Bindungen, die über ein Kostüm hinausgehen.",
      "Die Verfilmung von 1937 mit Ronald Colman macht die Doppelrolle durch denselben Darsteller sichtbar. Kurosawas „Kagemusha“ von 1980 verschiebt das Motiv ins Japan des 16. Jahrhunderts: Ein Dieb soll nach dem Tod Takeda Shingens dessen Weiterleben vortäuschen. Er übt Haltung und Bewegungen des Fürsten. Das Gefolge braucht den Körper als Zeichen fortbestehender Macht, während der Vertreter allmählich selbst an die Familie und das Heer gebunden ist. Der Wechsel vom Abenteuerroman zur historischen Tragödie verändert die Aufgabe des Doppelgängers: Die Vertretung rettet zeitweise eine Ordnung, deren Nachfolgeproblem bestehen bleibt."
    ],[],[S("Anthony Hope: The Prisoner of Zenda","https://www.gutenberg.org/ebooks/95"),S("Criterion: Kagemusha","https://www.criterion.com/films/948"),S("Wikipedia: Verfilmung von 1937","https://en.wikipedia.org/wiki/The_Prisoner_of_Zenda_(1937_film)")],"Prisoner of Zenda 1894 1937 Kagemusha political double"),

    card("Wichtige Akkorde und Akkordfolgen","Passamezzo moderno","Zwei verwandte harmonische Durchgänge: Der erste bleibt offen, der zweite schließt.",[
      "Der Passamezzo moderno war ein Grundmodell für Tanzmusik und Variationen im Europa des 16. Jahrhunderts. In G-Dur lautet sein Gerüst: G–C–G–D, danach G–C–G–D–G. Als Stufen: I–IV–I–V | I–IV–I–V–I. Der erste Durchgang endet auf der Dominante, der zweite führt von dort zur Tonika zurück. Das Diagramm zeigt diese Stationen, ohne feste Taktlängen vorzuschreiben.",
      "Die Akkordtöne sind G–H–D, C–E–G und D–Fis–A. Bei D–G führt der Leitton Fis aufwärts nach G; A sinkt nach G oder steigt nach H, je nach Satz. Die konkrete Stimmführung wird bei den Variationen ausgeschmückt. Zu hören ist Diego Ortiz’ „Recercada segunda sobre tenores italianos“ aus dem „Trattado de glosas“ von 1553, eingespielt von Phillip W. Serna: Die bewegliche Oberstimme setzt über dem wiederkehrenden Grundmodell immer neu an. Auch William Byrds „Quadran Pavan“ beruht auf diesem Modell."
    ],[diagram("passamezzo-moderno","Passamezzo moderno, nach G-Dur versetzt"),{type:"audio",src:"https://upload.wikimedia.org/wikipedia/commons/e/ec/Diego_Ortiz_%281510-1570%29_-_Recercada_segunda_sobre_tenores_italianos_from_Trattado_de_Glosas_%281553%29.ogg",href:"https://commons.wikimedia.org/wiki/File:Diego_Ortiz_(1510-1570)_-_Recercada_segunda_sobre_tenores_italianos_from_Trattado_de_Glosas_(1553).ogg",caption:"Ortiz: Recercada segunda sobre tenores italianos · Phillip W. Serna (2020), CC BY-SA 4.0"}],[S("Philharmonie de Paris: Passamezzo moderno","https://pad.philharmoniedeparis.fr/pad/doc/CIMU/1165073/passamezzo-moderno-instrumental"),S("Hyperion: Byrds Quadran Pavan","https://www.hyperion-records.co.uk/dw.asp?dc=W7624_66551"),S("Wikipedia: Passamezzo","https://de.wikipedia.org/wiki/Passamezzo")],"Passamezzo moderno Ortiz Recercada II Byrd Quadran harmonic ground"),

    card("Falsche Modelle mit großer Erklärungskraft","Euklids Sehstrahlen","Gerade Linien vom Auge zum Gegenstand erklären Perspektive, aber noch keinen Lichtempfang.",[
      "In seiner „Optik“, um 300 v. Chr., beschreibt Euklid einen Kegel aus geraden Sehstrahlen mit der Spitze im Auge. Ein Gegenstand erscheint größer, wenn er einen größeren Winkel dieses Kegels einnimmt. Mit solchen Konstruktionen werden verdeckte Teile und Änderungen der scheinbaren Größe berechenbar. Dafür ist zunächst die Geometrie der Verbindungslinien entscheidend.",
      "Die Vorstellung, beim Sehen gehe etwas aus dem Auge hervor, gerät jedoch in Schwierigkeiten, sobald man die Beleuchtung erklären muss. Ein gesundes Auge sieht in völliger Dunkelheit nichts; starkes einfallendes Licht verändert und schädigt die Wahrnehmung. Ibn al-Haytham untersuchte im frühen 11. Jahrhundert in Kairo solche Bedingungen und begründete ein Modell des ins Auge eintretenden Lichts. Die Sehwinkelgeometrie blieb brauchbar, während sich die Erklärung des physischen Vorgangs änderte."
    ],[diagram("sehkegel","Sehstrahlen im historischen Modell")],[S("UNESCO: Ibn al-Haythams wissenschaftliche Methode","https://courier.unesco.org/en/articles/ibn-al-haythams-scientific-method"),S("Stanford Encyclopedia: Euclid","https://plato.stanford.edu/entries/euclid/")],"Euclid Optics visual cone extramission Ibn al Haytham"),

    card("Entzifferte Schriften","RGYNʾ BT ḤRY BR ʿTʾ ḤBL","Palmyrenisches Aramäisch · Grabstein der Regina, etwa 175–200 n. Chr.",[
      "Der Grabstein wurde 1878 in South Shields an der Mündung des Tyne gefunden, beim römischen Kastell Arbeia im heutigen Nordostengland. Regina stammte aus der britischen Gemeinschaft der Catuvellaunen. Barates, der aus Palmyra im heutigen Syrien kam, hatte sie freigelassen und geheiratet. Das Denkmal nennt sie auf Latein und beklagt ihren Tod zusätzlich auf Palmyrenisch, einer aramäischen Sprachform.",
      "Die palmyrenische Schrift wird von rechts nach links gelesen und schreibt überwiegend Konsonanten. Die Umschrift außen bewahrt deshalb Zeichen wie ʾ und ʿ, statt ungesicherte Vokale einzusetzen. RGYNʾ steht für den Namen Regina; BR ʿTʾ für Barates. BT ḤRY bezeichnet hier die Freigelassene, ḤBL ist der Klageruf. Zweisprachige Inschriften aus Palmyra hatten Jean-Jacques Barthélemy schon 1754 geholfen, die Zeichenwerte zu erschließen. Als William Wright 1878 Reginas Zeile veröffentlichte, wandte er diese bekannte Schrift auf einen neuen britischen Fund an.",
      "Vollständige Übersetzung der außen wiedergegebenen palmyrenischen Zeile: „Regina, die Freigelassene des Barates, ach!“"
    ],[wm("7/75/Reginas-Tombstone-a-relief-portrait-with-inscriptions-in-Latin-and-Palmyrene-Copyright.jpg","Reginas-Tombstone-a-relief-portrait-with-inscriptions-in-Latin-and-Palmyrene-Copyright.jpg","Reginas Grabstein mit lateinischer und palmyrenischer Inschrift")],[S("North East Museums: The Regina Tombstone","https://www.northeastmuseums.org.uk/collections/stories/the-regina-tombstone"),S("Roman Inscriptions of Britain: RIB 1065","https://romaninscriptionsofbritain.org/inscriptions/1065"),S("University of Warwick: Regina of Arbeia","https://warwick.ac.uk/fac/arts/classics/warwickclassicsnetwork/romancoventry/resources/diversity/women/regina/")],"Regina Barates RIB 1065 Palmyrene Barthélemy Wright"),

    card("Etymologien und Begriffsgeschichten","Fetisch","Ein portugiesisches Wort für Gemachtes wurde zum Begriff für die Macht von Dingen.",[
      "Portugiesisch „feitiço“ geht auf lateinisch „facticius“, künstlich oder hergestellt, zurück. Es bezeichnete auch einen Zauber oder ein Zaubermittel. Im Handel an den Küsten Westafrikas verwendeten Europäer das Wort für Gegenstände, denen ihre Gesprächspartner besondere Kräfte zuschrieben. Die Bezeichnung entstand damit in konkreten Handels- und Machtverhältnissen; sie war keine einheitliche Eigenbezeichnung afrikanischer Religionen.",
      "Über französisch „fétiche“ gelangte das Wort im 18. Jahrhundert ins Deutsche. Charles de Brosses machte 1760 den „Fetischismus“ zu einer vermeintlich allgemeinen frühen Religionsform. Marx verschob 1867 im ersten Band des „Kapital“ den Gegenstand der Kritik: Beim Warenfetischismus erscheinen gesellschaftliche Beziehungen als Eigenschaften von Waren. Später wurde der Ausdruck auch in der Sexualwissenschaft verwendet. Die Bedeutungsverschiebungen betreffen jeweils eine andere Frage: Wer schreibt einem Ding welche Wirkung zu, und welche menschlichen Beziehungen werden dadurch verdeckt?"
    ],[],[S("Duden: Fetisch, Herkunft","https://www.duden.de/rechtschreibung/Fetisch"),S("Universität Köln: Postkoloniales Wörterbuch","https://postkoloniales-woerterbuch.uni-koeln.de/index.php?n=Main.Fetisch"),S("Wikipedia: Warenfetischismus","https://de.wikipedia.org/wiki/Warenfetischismus")],"Fetisch feitiço de Brosses 1760 Marx Warenfetischismus 1867"),

    card("Rhetorische und poetische Verfahren","„Vivit? immo vero etiam in senatum venit.“","Epanorthose · Cicero, Erste Rede gegen Catilina, 2",[
      "„Er lebt? Ja, mehr noch: Er kommt sogar in den Senat.“ Cicero hält im Jahr 63 v. Chr. eine Rede gegen Catilina, der selbst an der Sitzung teilnimmt. Zuerst behandelt der Redner dessen Weiterleben als empörenden Zustand. Dann greift er das eigene Wort auf und ersetzt es durch einen stärkeren Vorwurf: Catilina tritt weiterhin als politisch handlungsfähiger Senator auf.",
      "Die Epanorthose ist eine ausdrücklich vollzogene Selbstkorrektur. Hier berichtigt sie keinen Sachfehler. Das scheinbare Zurücknehmen lässt Cicero den Maßstab während des Sprechens verschärfen. Für den Hörer entsteht der Eindruck, schon die erste Formulierung sei dem Fall kaum gewachsen. Der wiederholte Wortanfang „vivit“ macht den Ansatz sichtbar; „immo vero“ kündigt die Korrektur an. Ihre Wirkung ergibt sich aus der genau bezeichneten Steigerung vom bloßen Leben zum demonstrativen öffentlichen Handeln."
    ],[],[S("Cicero: In Catilinam I, 2","https://www.thelatinlibrary.com/cicero/cat1.shtml"),S("Universität Bern: Tropen und Figuren","https://www.kps.unibe.ch/e40863/e306966/e1461206/files1461207/TropenundFigurenFS2018_ger.pdf")],"Cicero Vivit immo vero etiam in senatum venit Epanorthose",{languageInfo:[["Ausgangswort","vivit · er lebt"],["Korrektur","immo vero · ja, mehr noch"],["Verschärfung","etiam in senatum venit · er kommt sogar in den Senat"]]}),

    card("Urban Legends","Die Engel von Mons","Aus einer Erzählung von 1914 wurden angebliche Augenzeugenberichte einer Schlacht.",[
      "Nach dem britischen Rückzug aus Mons in Belgien im August 1914 kursierten Berichte über übernatürlichen Beistand. Ein entscheidender gedruckter Ausgangspunkt war Arthur Machens Erzählung „The Bowmen“, erschienen am 29. September 1914 in der Londoner „Evening News“. Darin greifen die Geister englischer Bogenschützen aus der Schlacht von Agincourt ein.",
      "1915 verbreiteten Zeitschriften und kirchliche Publikationen Fassungen mit leuchtenden Gestalten oder Engeln. Machen erklärte, seine Geschichte erfunden zu haben; Teile des Publikums behandelten sie dennoch als verschlüsselten Tatsachenbericht. Angebliche Aussagen von Frontsoldaten wurden häufig ohne überprüfbare Namen und Überlieferungswege weitergegeben. Späte Erinnerungen erschweren die Datierung zusätzlich. Belegt sind die Schlacht und die Verbreitung der Erzählungen. Die gesicherte Druckgeschichte allein beweist weder eine Erscheinung noch, dass jede spätere Variante unmittelbar aus Machens Text stammt."
    ],[wm("2/2e/Nov_29_1915_-_Illustrated_London_News_The_Ghostly_Bowmen_of_Mons_fight_the_Germans_%28cropped%29.jpg","Nov 29 1915 - Illustrated London News The Ghostly Bowmen of Mons fight the Germans (cropped).jpg","Zeitgenössische Darstellung der Geisterschützen, 1915")],[S("Wissenschaftliche Untersuchung: Angels of Mons","https://research.gold.ac.uk/11325/1/AngelsofMonspapersocieties-04-00180.pdf"),S("Wikipedia: Angels of Mons","https://en.wikipedia.org/wiki/Angels_of_Mons")],"Arthur Machen Bowmen 29 September 1914 Angels Mons legend"),

    card("Interessante Sprachen und Sprachmerkmale","Tok Pisin: yumi und mipela","Das Pronomen „wir“ legt fest, ob die angesprochene Person dazugehört.",[
      "Tok Pisin ist eine Verkehrssprache Papua-Neuguineas, unter anderem in Port Moresby, Lae und im Hochland der Insel Neuguinea. Es entstand in mehrsprachigen Kontakten und hat einen überwiegend englischstämmigen Wortschatz. Viele Menschen erwerben es zusätzlich zu einer örtlichen Sprache; für andere ist es die Erstsprache.",
      "„Yumi go long maket.“ bedeutet: „Wir gehen zum Markt, du gehörst dazu.“ In „Mipela go long maket.“ ist dieselbe Bewegung gemeint, doch die angesprochene Person gehört zur Gruppe der Gehenden nicht dazu. Im Deutschen ergänzt man dafür einen Nebensatz oder zeigt auf die gemeinte Gruppe. Tok Pisin verlangt die Unterscheidung bereits im Pronomen. „Go“ bezeichnet das Gehen; „long“ leitet hier das Ziel ein. Die beiden vollständigen Beispielsätze sind für diese Karte formuliert."
    ],[diagram("tok-pisin-wir","Einschließendes und ausschließendes „wir“")],[S("University of Hawaiʻi: Tok Pisin","https://www.hawaii.edu/satocenter/langnet/definitions/tokpisin.html"),S("APiCS: Inclusive/exclusive distinction","https://apics-online.info/surveys/22#section-5"),S("Australian National University: Tok Pisin","https://chl.anu.edu.au/language-tok-pisin")],"Tok Pisin yumi mipela inclusive exclusive pronouns Papua New Guinea",{languageInfo:[["Yumi go long maket.","wir.INKL gehen zu Markt · Wir gehen zum Markt, einschließlich dir."],["Mipela go long maket.","wir.EXKL gehen zu Markt · Wir gehen zum Markt, ohne dich."],["INKL / EXKL","einschließend / ausschließend; gemeint ist jeweils die angesprochene Person"]]}),

    card("Interessante Listen","Robert Boyles acht Vorschläge zur Forschungsorganisation","Eine Ergänzung seiner Erfindungswünsche aus dem 17. Jahrhundert.",[
      "In den Boyle Papers der Royal Society, Band 36, Blatt 77–78, steht eine von Robert Bacon abgeschriebene Wunschliste. Nach den erhofften Erfindungen folgen acht Vorschläge dazu, wie Forschung organisiert werden sollte. Die folgende Übersetzung gibt diese geschlossene Ergänzung in der Reihenfolge der Handschrift wieder.",
      "1. Preise und andere Belohnungen für Erfinder.",
      "2. Die Öffentlichkeit trägt die Kosten aussichtsreicher Versuche.",
      "3. Ein Verzeichnis dessen, was geleistet wurde, mit genauer Beschreibung der Verfahren.",
      "4. Ein Verzeichnis erwünschter Entdeckungen und vielseitig brauchbarer Mittel, der „Polychrista“.",
      "5. Belohnungen für Annäherungen an ein Ergebnis.",
      "6. Laufende Einnahmen für Versuche.",
      "7. Ein Rat zur Beratung.",
      "8. Eine Sammlung von Modellen und anderen aufschlussreichen Gegenständen aus Natur und Handwerk.",
      "Die Liste trennt die Belohnung einer fertigen Erfindung von der Finanzierung des Weges dorthin. Gerade der fünfte Punkt zählt Teilerfolge ausdrücklich mit. Was heute wie eine Verwaltungsfrage wirkt, steht bei Boyle unmittelbar neben Hoffnungen auf neue technische Fähigkeiten."
    ],[wm("thumb/a/a3/The_Shannon_Portrait_of_the_Hon_Robert_Boyle.jpg/1280px-The_Shannon_Portrait_of_the_Hon_Robert_Boyle.jpg","The Shannon Portrait of the Hon Robert Boyle.jpg","Robert Boyle")],[S("Royal Society: Boyle’s second list, mit Transkription","https://royalsociety.org/blog/2018/09/boyles-second-list/")],"Robert Boyle second list Robert Bacon 36 77 78 approximations"),

    card("Gute einfache Cartoons","Charles Philipon · Les Poires","Le Charivari · 17. Januar 1834, nach Philipons Entwurf von 1831",[
      "Vier Zeichnungen führen vom Kopf des französischen Königs Louis-Philippe zur Birne. Charles Philipon hatte die Folge im Zusammenhang mit seinem Prozess wegen Majestätsbeleidigung entwickelt. Das französische „poire“ bezeichnet zugleich eine Birne und einen Dummkopf. Die wiedererkennbare Kopfform genügte bald, um den König auch ohne Porträt zu verspotten."
    ],[wm("thumb/3/37/Les_Poires_cropped.jpg/1280px-Les_Poires_cropped.jpg","Les Poires cropped.jpg","Vier Bilder nach Philipons Entwurf; Holzstich in Le Charivari, 17. Januar 1834")],[S("Bibliothèque de Reims: Philipon und die Birne","https://www.bm-reims.fr/patrimoine/caricature-avant-1870-1.aspx"),S("Wikimedia Commons: Les Poires","https://commons.wikimedia.org/wiki/File:Les_Poires_cropped.jpg")],"Charles Philipon Les Poires Le Charivari 17 janvier 1834"),

    card("Grenzfälle","Unisexuelle Ambystoma","Eine rein weibliche Linie von Schwanzlurchen übernimmt gelegentlich Erbgut anderer Arten.",[
      "Im östlichen Nordamerika leben rein weibliche Linien von Querzahnmolchen der Gattung Ambystoma. Zur Fortpflanzung benötigen sie Spermien von Männchen verwandter Arten. Häufig löst das Spermium nur die Entwicklung der Eizelle aus. In anderen Fällen gelangt auch väterliches Erbgut in die Nachkommen; ein zusätzlicher Chromosomensatz bleibt erhalten oder ersetzt einen vorhandenen.",
      "Diese Fortpflanzungsweise heißt Kleptogenese. Die Tiere sind keine einfache Kreuzung, die sich anschließend als neue Art mit eigenen Männchen fortpflanzt. Die weibliche Linie besteht weiter, während die Zusammensetzung ihrer Chromosomensätze wechselt. In einer 2019 veröffentlichten Familienuntersuchung wurden 988 Nachkommen von 14 Müttern verglichen. Der Grenzfall betrifft die Artgrenze: Die mütterliche Abstammung und die Herkunft der übrigen Genome ergeben unterschiedliche Gruppierungen desselben Tiers."
    ],[],[S("Originalstudie: A family study to examine clonal diversity in unisexual salamanders","https://pubmed.ncbi.nlm.nih.gov/31172800/"),S("Kanadische Fachbehörde: Ambystoma, Schutz und Fortpflanzung","https://publications.gc.ca/collections/collection_2024/eccc/En3-4-323-2024-eng.pdf")],"unisexual Ambystoma kleptogenesis 988 offspring 14 mothers"),

    card("UnsichtbareKonventionen","O.S. und V.O. im Drehbuch","Eine unsichtbare Stimme gehört entweder zum Schauplatz oder zu einer anderen Erzählebene.",[
      "Steht neben dem Figurennamen „O.S.“ für „off screen“, spricht die Figur gewöhnlich am Schauplatz, befindet sich aber außerhalb des Bildausschnitts. Eine Frau am Küchentisch hört etwa ihren Bruder aus dem angrenzenden Flur. „V.O.“ für „voice over“ kennzeichnet dagegen zum Beispiel eine rückblickende Erzählerstimme über Bildern eines früheren Ereignisses.",
      "Der Unterschied entscheidet darüber, worauf die sichtbaren Figuren reagieren. Würde die Frau auf den rückblickenden Kommentar schauen, als spräche jemand im Flur, wäre die Trennung der Erzählebenen aufgehoben. Eine solche Reaktion eignet sich als gezielter Witz; ohne Vorbereitung wirkt sie wie ein räumlicher Fehler. Die Kürzel sind Arbeitskonventionen, keine vollständige Theorie des Filmtons. Gerade bei Telefonaten unterscheiden sich Drehbuchpraktiken. Der dargestellte Grundfall hält deshalb Stimme am Ort und nachträglichen Kommentar auseinander."
    ],[diagram("stimme-os-vo","Stimme am Schauplatz und nachträglicher Kommentar")],[S("Final Draft: Voice Over und Off-Screen","https://www.finaldraft.com/blog/how-to-use-voice-over-in-a-screenplay-formatting-and-best-practices-explained")],"screenplay OS VO off screen voice over distinction"),

    card("VerloreneTechniken","Guillochieren mit der Handzugmaschine","Eine geführte Schneide schneidet wiederholte Muster in Metall.",[
      "Beim Guillochieren wird ein Werkstück von Hand gedreht, während eine Schneide eine feine Furche in seine Oberfläche schneidet. Bei einer Rosettenmaschine bewegt eine geformte Scheibe den Werkstückträger periodisch seitwärts. Ihr Profil bestimmt, wie sich die Furche krümmt. Nach einem Umlauf wird die Einstellung geringfügig versetzt; daraus entsteht eine Folge eng benachbarter Linien.",
      "Der Guillocheur steuert die Drehung und den Druck der Schneide. Zu hoher Druck reißt das Metall aus, ungleichmäßiger Vorschub verändert die Tiefe. Seit dem späten 18. Jahrhundert wurde das Verfahren unter anderem für Uhrgehäuse und Zifferblätter verwendet. Geprägte Muster und später rechnergesteuerte Bearbeitung verdrängten einen großen Teil der Handarbeit. Einige Uhrenwerkstätten erhalten sie bis heute. In seitlichem Licht werden die geschnittenen Vertiefungen sichtbar; ihre wechselnden Reflexe gehören zur Wirkung des Musters."
    ],[wm("f/fd/Guilloche_without_Enamel.jpg","Guilloche without Enamel.jpg","Geschnittenes Guillochémuster vor einer Emailauflage")],[S("Patek Philippe: Guillochage, Werkzeuge und Handgriffe","https://www.patek.com/en/manufacture/artisans-of-time/guillochage"),S("Breguet: Artisans and machines","https://www.breguet.com/en/magazine-quai-de-l-horloge/edition-no-10/artisans-and-machines")],"Guillochieren Rosettenmaschine Handzug guillochage rose engine"),

    card("InternetArchäologie","Fourmilab · Your Sky","Ein Himmelskarten-Generator von 1998, bedient mit einfachen Webformularen.",[
      "John Walkers „Your Sky“ erzeugt seit 1998 Sternkarten für frei gewählte Orte und Zeitpunkte. Nach dem Öffnen erscheinen ein Formular und eine berechnete Karte. Für Mannheim werden etwa 49,49° Nord und 8,47° Ost eingetragen. Ein zweites Formular zeigt den Blick zum Horizont; das virtuelle Teleskop berechnet kleinere Himmelsausschnitte.",
      "Die Oberfläche besteht aus gewöhnlichen HTML-Seiten. Der Server erzeugt die Bilder nach jedem abgeschickten Formular neu; Flash oder ein Browser-Plugin sind dafür nicht nötig. Das Quellenarchiv enthält auch die Sternkataloge und den Programmcode. Historische Karten berücksichtigen die Präzession, also die langsame Änderung der Erdachsenrichtung. Bei sehr weit zurückliegenden Daten sind deshalb das benutzte Koordinatenmodell und die Genauigkeit der Kataloge wichtiger als die scheinbare Genauigkeit des eingegebenen Datums."
    ],[],[S("Fourmilab: Your Sky","https://www.fourmilab.ch/yoursky/"),S("Bedienung und historische Karten","https://www.fourmilab.ch/yoursky/help/help.html"),S("Originalprogramm und Entstehungsjahr","https://github.com/Fourmilab/YourSky")],"John Walker Fourmilab Your Sky 1998 historical sky map"),

    card("SchlechtesWritingSeziert","Sherlock · die Bombe in The Empty Hearse","Staffel 3, Folge 1 (2014) · Eine erzwungene Versöhnung wird zur Pointe.",[
      "Sherlock und John finden in einem stillgelegten U-Bahn-Wagen eine Bombe. Sherlock behauptet, sie nicht entschärfen zu können. Unter dem Eindruck des bevorstehenden Todes spricht John ihm Vergebung aus. Erst danach zeigt sich, dass Sherlock einen Ausschalter gefunden hatte und die Gefahr beherrschte. Er hat Johns Todesangst benutzt, um die Versöhnung zu erzwingen.",
      "Die Szene setzt das Geständnis zunächst als ernstes Ergebnis einer gemeinsamen Notlage. Der anschließende Scherz entzieht ihm diese Grundlage. Das Problem ist weniger der einfache Schalter als die Behandlung des Vertrauensbruchs: Die komische Auflösung bietet kaum Raum für die Folgen der Täuschung. Dass Sherlock manipulativ handelt, wäre ein tragfähiger Konflikt; die Szene müsste Johns Reaktion dann als mehr als eine kurze Verärgerung behandeln.",
      "Lösung 1: Sherlock findet den Schalter erst nach Johns Worten. Er bleibt kurz stumm, statt die Rettung zum eigenen Triumph zu machen. Die Vergebung behält ihren freiwilligen Charakter.",
      "Lösung 2: John bemerkt den längst gestoppten Countdown, bevor er antwortet. Er entscheidet selbst, was er Sherlock trotz der Täuschung sagen will.",
      "Lösung 3: Die Täuschung bleibt erhalten. John beendet danach die Zusammenarbeit für eine konkrete Zeit; Sherlock muss Vertrauen durch eine spätere Entscheidung zurückgewinnen. Der Scherz hätte damit eine anhaltende Folge."
    ],[],[S("PBS Masterpiece: The Empty Hearse, mit Episodentranskript","https://www.pbs.org/wgbh/masterpiece/shows/sherlock/episodes/s3-e1/")],"Sherlock Empty Hearse bomb switch John forgiveness scene"),

    card("DasIstHierGanzInDerNähe","Ziegeleimuseum Jockgrim","Untere Buchstraße 22a · rund 44 km Luftlinie südlich von Mannheim",[
      "Das Ziegeleimuseum liegt auf dem Gelände der ehemaligen Falzziegelwerke Carl Ludowici in Jockgrim, zwischen Germersheim und Karlsruhe. Ein Teil des begehbaren Ringofens ist erhalten. Die ursprüngliche Anlage war etwa 90 Meter lang. In einem Ringofen wandert die Brennzone von Kammer zu Kammer, während andere Kammern abkühlen oder mit frischen Ziegeln beschickt werden. Der Gang macht die räumliche Organisation dieser fortlaufenden Produktion sichtbar.",
      "Draußen stehen Maschinen aus der Ziegelherstellung. Zum Museum gehört außerdem Ludowicis restauriertes Kugelhaus aus den 1950er Jahren. Adresse: Untere Buchstraße 22a, 76751 Jockgrim. Regulär geöffnet ist mittwochs und samstags von 14 bis 17 Uhr sowie sonntags von 10 bis 17 Uhr; Gruppenführungen sind nach Vereinbarung möglich. Die verlinkte Tourismusinformation nennt auch zeitweilige Schließungen."
    ],[
      I("https://www.pfalz.de/sites/default/files/styles/gallery_preview/public/deskline/8d3284ac-a65f-45eb-b638-5eb24d80eab2/b4aea2e8-afce-409b-afe6-e26b74f56e5d/e7ffc967-0888-40f0-85d0-bdc305e96e58.jpg.webp?itok=6qBhyCnP","https://www.pfalz.de/de/sehenswuerdigkeit/ziegeleimuseum-jockgrim","Im erhaltenen Ringofen","Pfalz Touristik"),
      I("https://www.pfalz.de/sites/default/files/styles/gallery_preview/public/deskline/8d3284ac-a65f-45eb-b638-5eb24d80eab2/b4aea2e8-afce-409b-afe6-e26b74f56e5d/0d6e17a1-c825-4560-98c3-6bd215712711.jpg.webp?itok=SXrwTq3N","https://www.pfalz.de/de/sehenswuerdigkeit/ziegeleimuseum-jockgrim","Ludowicis Kugelhaus","Pfalz Touristik")
    ],[S("Pfalz Touristik: Ziegeleimuseum Jockgrim","https://www.pfalz.de/de/sehenswuerdigkeit/ziegeleimuseum-jockgrim"),S("Museumsverband Rheinland-Pfalz","https://www.museumsportal-rlp.de/museen/ziegeleimuseum-jockgrim")],"Ziegeleimuseum Jockgrim Ringofen Kugelhaus Untere Buchstraße 22a"),

    card("VisuelleIdeenDieIchKlauenWill","Alvin Langdon Coburn · Refracted Window","Eine Atelierverglasung, durch drei Spiegel fotografiert · 1916–17",[
      "Coburn setzte drei Spiegel vor das Objektiv, sodass sie einen dreieckigen Kanal bildeten. Das Prinzip ähnelt einem Kaleidoskop. Bei diesem „Vortograph“ ist eine Atelierverglasung aufgenommen: Ihre Geraden werden mehrfach reflektiert und erscheinen als gegeneinander versetzte helle und dunkle Flächen. Die Abstraktion entstand bei der Aufnahme.",
      "Für einen eigenen Versuch braucht der Ausgangsgegenstand deutliche Hell-Dunkel-Grenzen. Eine helle Fensterfläche hinter einem dunklen Rahmen genügt. Entscheidend sind der Winkel der Spiegel und der Abstand zum Objektiv: Schon eine kleine Drehung verändert, welche Teilansichten zusammentreffen. Das Motiv wird am besten durch den Sucher gewählt, weil die gewöhnliche Ansicht des Gegenstands die spätere Anordnung kaum vorwegnimmt. Coburns Beispiel zeigt, wie ein räumlich einfacher Gegenstand ohne nachträgliche Montage mehrere Bildrichtungen erhält."
    ],[diagram("vortoskop","Drei Spiegel vor dem Objektiv · eigene Erklärung des Aufnahmeverfahrens")],[S("Metropolitan Museum: Refracted Window","https://www.metmuseum.org/art/collection/search/264620"),S("MoMA: Coburns Vortograph-Verfahren","https://www.moma.org/interactives/objectphoto/objects/83725.html")],"Alvin Langdon Coburn Refracted Window Vortograph mirrors 1917"),

    card("Eigene GIFs","Ein freies Feld","",[],[I("assets/gifs/ein-freies-feld.gif","assets/gifs/ein-freies-feld.gif","Ein freies Feld","Eigene Animation")],[],"Schiebepuzzle freie Zelle zyklische Bewegung",{kind:"gif"}),

    card("Trends in Art","Anna Aristova · Space for 2","RCA-Abschlussausstellung 2026 · handgeschöpftes Baumwollpapier und Kiefernholz",[
      "„Space for 2“ ist eine Installation für Begegnungen zwischen jeweils zwei Personen. Anna Aristova entwickelte sie für ihren Abschluss im Fach Bildhauerei am Royal College of Art in London. Der hier gezeigte Entwurf stellt ein hohes, schmales Holzgerüst dar. Helles Papier füllt dessen rechteckige Felder aus; am Boden bleibt eine Öffnung für die Besucher. Das kleine Treffen findet damit unter einem Bau statt, der weit über die Körper hinausreicht.",
      "Für das handgeschöpfte Papier wurden gebrauchte Baumwollseile eines britischen Herstellers verarbeitet. Darauf stehen im Buchdruck gesetzte Texte aus Gesprächen mit Studierenden des Bildhauereijahrgangs über Intimität. Wer sich zum Gespräch in die Installation begibt, trifft dort also auf die schriftlich festgehaltenen Antworten anderer. Die Abbildung ist eine von der Künstlerin veröffentlichte Entwurfsansicht; die Hochschule nennt handgeschöpftes Baumwollpapier und Kiefernholz als Materialien der ausgestellten Arbeit."
    ],[I("https://images.squarespace-cdn.com/content/v1/5a399eab64b05f95d18b8bae/f573c4cd-b481-47d7-b65e-b8e44cb107f6/Space+for+Two+Front.png","https://www.aristovadesign.com/","Space for 2 · Entwurfsansicht, 2026","© Anna Aristova")],[S("Anna Aristova: Space for 2","https://www.aristovadesign.com/"),S("Royal College of Art: Abschlussausstellung 2026","https://www.rca.ac.uk/news-and-events/news/announcing-rca2026-school-of-arts-humanities-show/")],"Anna Aristova Space for 2 RCA 2026 cotton handmade paper pine"),

    card("Writing Tipps","Gemeinsames Wissen aus Dialogen streichen","Edith Wharton · The Writing of Fiction (1925)",[
      "Unterstreiche in einem Dialog alle Angaben, die beide Figuren bereits kennen. Prüfe anschließend bei jeder Angabe, weshalb sie gerade jetzt ausgesprochen wird. Ein Vorwurf, eine Drohung oder eine absichtliche Prüfung des Gegenübers rechtfertigt die Wiederholung. Fehlt ein solcher Anlass, gehört die Information meist in die Erzählung oder an eine frühere Stelle.",
      "Wharton beschreibt den Aufwand, der entsteht, wenn Gespräche den gesamten Bericht übernehmen sollen: Die Figuren müssen einander Bekanntes erklären. Um das zu verdecken, wird ihre Rede mit alltäglichen Nebensachen verlängert. Ein genauer Eingriff besteht darin, die erklärende Passage zunächst durch einen einzigen Erzählsatz zu ersetzen. Danach bleibt im Gespräch nur, was die Beziehung oder die Entscheidung der Beteiligten verändert. Die Quelle erläutert diese Schwierigkeit an ausufernden Gesprächspassagen bei Trollope."
    ],[wm("thumb/5/52/Edith_Newbold_Jones_Wharton_%28cropped_02%29.jpg/1280px-Edith_Newbold_Jones_Wharton_%28cropped_02%29.jpg","Edith Newbold Jones Wharton (cropped 02).jpg","Edith Wharton")],[S("Edith Wharton: The Writing of Fiction","https://www.gutenberg.org/ebooks/72446"),S("Nachgeladene Transkription","https://raw.githubusercontent.com/GITenberg/The-writing-of-fiction_72446/master/72446-0.txt")],"Edith Wharton dialogue narrative things each already knows",{writingSource:{label:"Edith Wharton · The Writing of Fiction, Kapitel III",source:"https://www.gutenberg.org/ebooks/72446",remote:{url:wharton,start:"Another argument against the substitution of dialogue for narrative",end:"III\n\nIn writing of the short story",flexibleMarkers:true,reflow:true,fetchLabel:"GITenberg-Transkription"}}}),

    card("Englisch Vokabular","chivvy","jemanden antreiben; durch wiederholtes Zureden zu etwas bewegen",[],[],[S("Cambridge Dictionary: chivvy","https://dictionary.cambridge.org/dictionary/english/chivvy"),S("Oxford Learner’s Dictionaries: chivvy","https://www.oxfordlearnersdictionaries.com/definition/english/chivvy")],"chivvy chivvy along into doing meaning examples",{vocabulary:{pronunciation:"/ˈtʃɪv.i/",register:"britisch, informell; Verb mit Personenobjekt",meaning:"Chivvy bezeichnet beharrliches Antreiben, häufig mit gutmütigem, gelegentlich lästigem Nachdruck. Chivvy someone along heißt, jemanden zum Weitermachen anzuhalten; chivvy someone into doing something heißt, ihn durch Zureden zu einer Handlung zu bewegen.",examples:[{en:"We had to chivvy Dan along or we would have missed the train.",de:"Wir mussten Dan etwas antreiben, sonst hätten wir den Zug verpasst."},{en:"She chivvied me into applying for the job.",de:"Sie redete mir so lange zu, bis ich mich auf die Stelle bewarb."},{en:"Stop chivvying me; I need a minute to think.",de:"Hör auf, mich zu drängen; ich brauche eine Minute zum Nachdenken."}]}}),

    card("Geo Atlas","Torresstraße","Der Meeresraum zwischen Australien und Neuguinea hat mehrere verschiedene Grenzlinien.",[
      "Die Torresstraße liegt zwischen der australischen Kap-York-Halbinsel und der Südküste Neuguineas. Zahlreiche Inseln gehören zu Australien, auch solche dicht vor der Küste Papua-Neuguineas. Die Lagekarte zeigt unter anderem Thursday Island und die nördlichen Inseln Saibai und Boigu. Für die dortigen Gemeinschaften war das Meer lange ein Verkehrsraum mit Fischgründen und Verwandtschaftsbeziehungen über die heutige Staatsgrenze hinweg.",
      "Australien und Papua-Neuguinea unterzeichneten 1978 den Torres-Strait-Vertrag; er trat 1985 in Kraft. Er unterscheidet die Zuständigkeit für den Meeresboden von der für die Fischerei und richtet zusätzlich eine Schutzzone ein. Für bestimmte traditionelle Aktivitäten erhalten die ansässigen Gemeinschaften besondere Möglichkeiten des Grenzübertritts. Deshalb beschreibt eine einzige Linie auf einer politischen Weltkarte die Ordnung dieses Meeresraums nur unvollständig. Welche Regel gilt, hängt auch davon ab, ob es um Bodenschätze, Fangrechte oder die überlieferte Nutzung durch die Bewohner geht."
    ],[wm("thumb/c/cf/Torres_Strait_Islands_map.svg/1280px-Torres_Strait_Islands_map.svg.png","Torres Strait Islands map.svg","Torresstraße mit Australien, Papua-Neuguinea und den Inselgruppen")],[S("Australisches Außenministerium: Torres-Strait-Vertrag","https://www.dfat.gov.au/geo/torres-strait/the-torres-strait-treaty"),S("National Archives of Australia: Vertrag von 1978","https://www.naa.gov.au/help-your-research/fact-sheets/torres-strait-treaty-1978"),S("Wikipedia: Torresstraße","https://de.wikipedia.org/wiki/Torresstra%C3%9Fe")],"Torres Strait treaty seabed fisheries boundary Boigu Saibai Thursday Island",{wiki:wiki("Torresstraße")}),

    card("Deutsche Sprichwörter in kyrillischen Buchstaben","Der Apfel fällt nicht weit vom Stamm.","Дер Апфель фэльт нихьт вайт фом Штам.",[
      "Die Umschrift richtet sich nach der deutschen Standardaussprache: /deːɐ̯ ˈapfl̩ fɛlt nɪçt vaɪ̯t fɔm ʃtam/. Шт steht für das am Wortanfang als scht gesprochene st. Ай gibt den Doppellaut ei wieder; das v in „vom“ wird als f gesprochen und deshalb mit ф geschrieben. Die Folge хь nähert den weichen ich-Laut in „nicht“ an. Д bleibt die feste Entsprechung für d."
    ],[],[S("Duden: Der Apfel fällt nicht weit vom Stamm","https://www.duden.de/suchen/dudenonline/Der%20Apfel%20f%C3%A4llt%20nicht%20weit%20vom%20Stamm"),S("Wikipedia: Kyrillisches Alphabet","https://de.wikipedia.org/wiki/Kyrillisches_Alphabet")],"Der Apfel fällt nicht weit vom Stamm Aussprache Sprichwort"),

    card("Deutsche Sprichwörter in griechischen Buchstaben","Reden ist Silber, Schweigen ist Gold.","Ρέδεν ιστ Ζίλμπερ, Σ̌βάϊγκεν ιστ Γκολτ.",[
      "Zugrunde liegt /ˈʁeːdn̩ ɪst ˈzɪlbɐ ˈʃvaɪ̯ɡn̩ ɪst ɡɔlt/. δ steht nach der festen Projektregel für d. ζ entspricht dem stimmhaften s in „Silber“, σ dem stimmlosen s in „ist“. Σ̌ ist eine behelfsmäßige Kennzeichnung für sch; β gibt das w wieder. μπ und γκ stehen hier für b und g. Das d am Ende von „Gold“ ist durch die deutsche Auslautverhärtung als t zu hören und erscheint deshalb als τ. Es handelt sich um eine Lautannäherung des Deutschen, nicht um einen griechischen Satz."
    ],[],[S("Duden: Reden ist Silber, Schweigen ist Gold","https://www.duden.de/suchen/dudenonline/Reden%20ist%20Silber%20Schweigen%20ist%20Gold"),S("Wikipedia: Griechisches Alphabet","https://de.wikipedia.org/wiki/Griechisches_Alphabet")],"Reden ist Silber Schweigen ist Gold Aussprache griechische Buchstaben")
  );
})();
