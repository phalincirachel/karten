...
const remoteOriginals={
  ...
  "Sedna und der Eissturmvogel · Oqomiut und Akudnirmiut":{url:GITENBERG.boas,start:"SEDNA AND THE FULMAR.",end:"THE TORNIT.",reflow:true,fetchLabel:"GITenberg-Transkription"},
  "Māui fängt die Sonne · Māori":{url:GREY,start:"The young hero, Maui, had not been long at home",end:"Maui-taha and his brothers after this feat",reflow:true,ocr:true,replacements:[["eyery day","every day"],["risnig up","rising up"],["Tama- nui-te-Ea","Tama-nui-te-Ra"],["oh, man 1","oh, man!"]],fetchLabel:"Digitalisat-Text bei Internet Archive"},
  "Warum Sonne und Mond am Himmel leben · Efik":{url:GITENBERG.dayrell,encoding:"windows-1252",start:"_Why the Sun and the Moon live in the Sky_",end:"_Why the Flies Bother the Cows_",reflow:true,fetchLabel:"GITenberg-Transkription"},
  ...
  "Das arme Truthahnmädchen · Zuni":{url:GITENBERG.cushing,start:"THE POOR TURKEY GIRL\n\n\nLong, long ago",end:"HOW THE SUMMER BIRDS CAME",reflow:true,fetchLabel:"GITenberg-Transkription"},
  ...
  "Die Ermordung Tuwhakararos · Māori":{url:GREY,start:"THE LEGEND OF TUWHAKARARO, HOW HE WAS MUEDEEED AND AVENGED.",end:"THE LEGEND OF RATA,",reflow:true,ocr:true,replacements:[["MUEDEEED","MURDERED"]],fetchLabel:"Digitalisat-Text bei Internet Archive"},
  "Die Schildkröte mit der schönen Tochter · Efik":{url:GITENBERG.dayrell,encoding:"windows-1252",start:"_The Tortoise with a Pretty Daughter_",end:"_How a Hunter obtained Money",reflow:true,fetchLabel:"GITenberg-Transkription"},
  "Die Frau mit zwei Häuten · Efik":{url:GITENBERG.dayrell,encoding:"windows-1252",start:"_The Woman with Two Skins_",startLast:true,end:"_The King's Magic Drum_",reflow:true,fetchLabel:"GITenberg-Transkription"},
  "Warum die Fledermaus nachts fliegt · Efik":{url:GITENBERG.dayrell,encoding:"windows-1252",start:"_Why the Bat flies by Night_",end:"_The Disobedient Daughter who Married a Skull_",reflow:true,fetchLabel:"GITenberg-Transkription"},
  "Die Zaubertrommel · Efik":{url:GITENBERG.dayrell,encoding:"windows-1252",start:"_The King's Magic Drum_",startLast:true,end:"_Ituen and the King's Wife_",reflow:true,fetchLabel:"GITenberg-Transkription"}
};

for(const card of window.KARTEN){
  const remote=remoteOriginals[card.title];
  if(remote)card.original={...card.original,source:card.original?.source||card.sources?.[0]?.url,remote};
}
